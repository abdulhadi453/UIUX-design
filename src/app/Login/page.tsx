...
function page() {
  return (
    <div className="w-[1440px] h-[966px] relative overflow-hidden bg-white">
      <div className="w-[1440px] h-24 absolute left-0 top-0">
        <div className="w-[1440px] h-[60px] absolute left-0 top-9 bg-white">
          ...
          <div className="w-[1440px] h-[60px] absolute left-0 top-0">
            <div className="w-[180px] h-10 absolute left-[1118px] top-2.5">
              <div className="w-[180px] h-10 absolute left-0 top-0 rounded-[100px] bg-neutral-100">
                <div className="w-[84px] h-6 absolute left-12 top-2 overflow-hidden">
                  <p className="w-[53.31px] h-6 absolute left-0 top-0 text-base text-left text-[#ccc]">
                    Search
                  </p>
                </div>
              </div>
        ...
        <div className="w-[1440px] h-9 absolute left-0 top-0 bg-neutral-100">
          <div className="w-[1440px] h-9 absolute left-0 top-0">
            ...
            <div className="flex justify-start items-center absolute left-[1122.22px] top-0">
              <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-[13.96875px] pl-3 pr-[5.15625px] py-2">
                <Link rel="stylesheet" href="AllProduct">
                  <p className="flex-grow-0 flex-shrink-0 text-[11px] font-medium text-left text-[#111]">
                    Find a Store
                  </p>
                </Link>
                <p className="flex-grow-0 flex-shrink-0 text-xs text-left text-[#111]">
                  |
                </p>
              </div>
              <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-[12.6875px] pl-2 pr-[4.125px] py-[11px]">
              ...
              <div className="flex-grow-0 flex-shrink-0 w-[122.5px] h-9 relative">
                ...
                <p className="absolute left-[60.02px] top-[11px] text-xs text-left text-[#111]">
                  |
                </p>
                <Link rel="stylesheet" href="Login">
                  <p className="absolute left-[75.14px] top-[11px] text-[11px] font-medium text-center text-[#111]">
                    Sign In
                  </p>
                </Link>
              </div>
      ...
      <div className="w-[380px] h-[489px] absolute left-[530px] top-24 bg-white">
        <div className="w-[324px] h-32 absolute left-7 top-7">
          <Image
            src="/nike.png"
            width={324}
            height={17}
            className="absolute left-[-1px] top-[-1px] object-none"
            alt="image"
          />
        ...
        <div className="w-[324px] h-[305px] absolute left-7 top-[156px] overflow-hidden">
          ...
          <div className="w-[324px] h-6 absolute left-0 top-[276px]">
            <p className="w-[129.61px] h-3.5 absolute left-[97.3px] top-2.5 text-xs text-center">
              ...
              <a href="JoinUs"><span className="w-[129.61px] h-3.5 text-xs text-center text-[#111]">
                Join Us.
              </span></a>
            </p>
          </div>
      ...
      <div className="w-[1440px] h-[331px] absolute left-0 top-[635px] bg-[#111]">
        <div className="w-[1440px] h-[331px] absolute left-0 top-0">
            ...
            <div className="w-[1029px] h-[213px] absolute left-0 top-0">
              ...
              <div className="w-[245.25px] h-[213px] absolute left-[263.25px] top-0 overflow-hidden">
                <div className="w-[245.25px] h-[210px] absolute left-0 top-0">
                  ...
                  <p className="w-[72.11px] h-[17px] absolute left-0 top-8 text-xs text-left text-[#7e7e7e]">
                    Order Status
                  </p>
                  <p className="w-[46.03px] h-[17px] absolute left-0 top-[63px] text-xs text-left text-[#7e7e7e]">
                    Delivery
                  </p>
                  <p className="w-[44.29px] h-[17px] absolute left-0 top-[94px] text-xs text-left text-[#7e7e7e]">
                    Returns
                  </p>
                  <p className="w-[96.61px] h-[17px] absolute left-0 top-[125px] text-xs text-left text-[#7e7e7e]">
                    Payment Options
                  </p>
                  <p className="w-[188.39px] h-[17px] absolute left-0 top-[156px] text-xs text-left text-[#7e7e7e]">
                    Contact Us On Nike.com Inquiries
                  </p>
                  <p className="w-[186.17px] h-[17px] absolute left-0 top-[187px] text-xs text-left text-[#7e7e7e]">
              ...
              <div className="w-[245.25px] h-[151px] absolute left-[520.5px] top-0 overflow-hidden">
                <div className="w-[245.25px] h-[148px] absolute left-0 top-0">
                  ...
                  <p className="w-[31.12px] h-[17px] absolute left-0 top-8 text-xs text-left text-[#7e7e7e]">
                    News
                  </p>
                  <p className="w-[44.67px] h-[17px] absolute left-0 top-[63px] text-xs text-left text-[#7e7e7e]">
                    Careers
                  </p>
                  <p className="w-[51.84px] h-[17px] absolute left-0 top-[94px] text-xs text-left text-[#7e7e7e]">
                    Investors
                  </p>
                  <p className="w-[76.47px] h-[17px] absolute left-0 top-[125px] text-xs text-left text-[#7e7e7e]">
                    Sustainability
                  </p>
                </div>
              </div>
          ...
          <div className="w-[1372px] h-[62px] absolute left-[34px] top-[269px]">
            <div className="w-[672px] h-8 absolute left-2 top-3">
              <div className="flex justify-start items-end absolute left-0 top-[17px] gap-2 pr-[8.28125px]">
                <svg
                  width="18"
                  height="15"
                  viewBox="0 0 18 15"
              ...
              <p className="w-[213.61px] h-[17px] absolute left-[77.28px] top-[17px] text-xs text-left text-[#7e7e7e]">
                © 2023 Nike, Inc. All Rights Reserved
              </p>
            </div>
            <div className="w-[680px] h-[46px] absolute left-[686px] top-4">
              <p className="w-[40.26px] h-[17px] absolute left-[291.64px] top-[15px] text-xs text-center text-[#7e7e7e]">
                Guides
              </p>
              <p className="w-[76.82px] h-[17px] absolute left-[359.7px] top-[15px] text-xs text-right text-[#7e7e7e]">
                Terms of Sale
              </p>
              <p className="w-[73.72px] h-[17px] absolute left-[464.33px] top-[15px] text-xs text-right text-[#7e7e7e]">
                Terms of Use
              </p>
              <p className="w-[106.36px] h-[17px] absolute left-[565.84px] top-[15px] text-xs text-right text-[#7e7e7e]">
                Nike Privacy Policy
              </p>
            </div>
          </div>
